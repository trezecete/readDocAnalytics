...
O modelo `gemini-2.5-flash` foi validado em `europe-west3` neste projeto. Se voce trocar `GEMINI_MODEL`, confirme que o modelo esta disponivel na mesma regiao configurada em `GCP_LOCATION`.
